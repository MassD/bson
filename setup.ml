...
(* OASIS_START *)
(* DO NOT EDIT (digest: 06e077c8683dbf2d9c34036f798e5127) *)
(*
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the bson syntax extension";
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("camlp4.metagenerator", None);
                           FindlibPackage ("camlp4.extend", None);
                           FindlibPackage ("deriving-ocsigen", None);
                           FindlibPackage ("deriving-ocsigen.syntax", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the client-side library";
                      flag_default = [(OASISExpr.EBool true, false)];
                      });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Bson_ext_client"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "bson";
                      lib_findlib_name = Some "client";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     cs_name = "bson_client_syntax";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("deriving-ocsigen", None);
                           FindlibPackage
                             ("js_of_ocaml.deriving.syntax", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Pa_bson_client"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "bson_client";
                      lib_findlib_name = Some "syntax";
                      lib_findlib_containers = [];
                      })
            ];
          plugins =
            [(`Extra, "META", Some "0.3"); (`Extra, "StdFiles", Some "0.3")];
          schema_data = PropList.Data.create ();
          plugin_data = [];
          };
     oasis_fn = Some "_oasis";
     oasis_version = "0.3.0";
     oasis_digest = Some "\147c\022Ç&±ü\156÷e\021\131Ê°||";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
